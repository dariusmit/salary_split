...
export function InfoCircleIcon({ size = 14, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LockClosedIcon({ size = 14, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LockOpenIcon({ size = 14, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
